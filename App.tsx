...
export default function App() {
  ...
  const handleCreatePost = (title: string, desc: string, type: PostType, phone?: string) => {
  ...
  const renderContent = () => {
      switch(currentView) {
          ...
          default:
              return (
                <>
                    <Hero onOpenPostModal={() => openCreateModal('post')} />
                    ...
                    {/* Functional sections kept but de-prioritized visually for the landing page flow */}
                    <div id="solidarity" className="scroll-mt-24 px-5 max-w-[1200px] mx-auto mb-16">
                        <SolidaritySection
                            alerts={alerts}
                    ...
                    <div id="chat" className="scroll-mt-24 px-5 max-w-[1200px] mx-auto mb-16">
                        <ChatSection
                            messages={messages}
