...
const INITIAL_POSTS: Post[] = [
  { id: 1, title: "Eletricista Residencial", desc: "Instalação de tomadas, chuveiros e reparos. Orçamento grátis.", author: "Carlos Ruiz", type: "autonomo", latitude: -23.5510, longitude: -46.6340, phone: "11999999999", reviews: [{id: 1, postId: 1, author: "Mariana", rating: 5, comment: "Excelente profissional!", timestamp: "Ontem"}] },
  { id: 2, title: "Pães Artesanais - 20% OFF", desc: "Toda a linha de fermentação natural com desconto hoje.", author: "Padaria do Zé", type: "promocao", latitude: -23.5520, longitude: -46.6320, phone: "11988888888" },
  { id: 3, title: "Mercadinho da Esquina", desc: "Entregas gratuitas para compras acima de R$50 no bairro.", author: "Mercadinho Bom Dia", type: "comercio", latitude: -23.5490, longitude: -46.6350, phone: "11977777777" },
  { id: 4, title: "Aulas de Inglês", desc: "Aulas particulares para crianças e adolescentes. Primeira aula grátis.", author: "Ana Lima", type: "autonomo", latitude: -23.5500, longitude: -46.6310, phone: "11966666666" }
];
