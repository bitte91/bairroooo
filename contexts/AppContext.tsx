...
import { User, Post, Alert, Message, ToastNotification, PostType, AlertType, Favorite, Notification, Report, Review } from '../types';
...
const INITIAL_POSTS: Post[] = [
  { id: 1, title: "Eletricista Residencial", desc: "Instalação de tomadas, chuveiros e reparos. Orçamento grátis. Atendo CECAP e região.", author: "Carlos Ruiz", type: "autonomo", latitude: -23.0300, longitude: -45.5500, phone: "12999999999", neighborhood: "CECAP", isHighlighted: true, reviews: [{id: 1, postId: 1, author: "Mariana", rating: 5, comment: "Excelente profissional, resolveu rápido!", timestamp: "Ontem"}] },
  { id: 2, title: "Pães Artesanais - 20% OFF", desc: "Toda a linha de fermentação natural com desconto hoje para retirada.", author: "Padaria do Zé", type: "promocao", latitude: -23.0250, longitude: -45.5600, phone: "12988888888", neighborhood: "Independência", discount: "20% OFF" },
  { id: 3, title: "Mercadinho da Esquina", desc: "Entregas gratuitas para compras acima de R$50 no bairro Vila Olímpia.", author: "Mercadinho Bom Dia", type: "comercio", latitude: -23.0400, longitude: -45.5700, phone: "12977777777", neighborhood: "Vila Olímpia" },
  { id: 4, title: "Aulas de Inglês", desc: "Aulas particulares para crianças e adolescentes. Primeira aula grátis.", author: "Ana Lima", type: "autonomo", latitude: -23.0350, longitude: -45.5550, phone: "12966666666", neighborhood: "Centro", isHighlighted: true },
  { id: 5, title: "Encanador 24h", desc: "Vazamentos, desentupimentos e reparos hidráulicos. Atendimento rápido.", author: "João Silva", type: "autonomo", latitude: -23.0280, longitude: -45.5520, phone: "12955555555", neighborhood: "Bonfim" }
];
...
export const AppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const addReport = (report: Report) => {
      ...
      addToast("Conteúdo denunciado. Obrigado por ajudar a manter a comunidade segura.", "success");
  };

  const dismissReport = (id: number) => {
      setReports(prev => prev.filter(r => r.id !== id));
      addToast("Denúncia ignorada.", "success");
  };

  const addReview = (review: Review) => {
      setPosts(prev => prev.map(p => {
          if (p.id === review.postId) {
              const currentReviews = p.reviews || [];
              return { ...p, reviews: [review, ...currentReviews] };
          }
          return p;
      }));
