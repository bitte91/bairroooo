...
export const BottomNav: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 pb-safe md:hidden z-50 safe-area-bottom">
          ...
          >
            {({ isActive }) => (
              <>
                <item.icon
                  size={22}
                  className={isActive ? 'fill-emerald-100 dark:fill-emerald-900/30' : ''}
                  strokeWidth={2.5}
